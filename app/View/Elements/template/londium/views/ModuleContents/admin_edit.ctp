<?php echo $this->Form->create("ModuleContent", array("class" => "form-horizontal", "action" => "edit", "id" => "formSubmit", "inputDefaults" => array("error" => array("attributes" => array("wrap" => "label", "class" => "error"))))) ?>
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <?php
            echo $this->Form->label("parent_id", __("Parent"), array("class" => "col-sm-2 control-label"));
            echo $this->Form->input("parent_id", array("div" => array("class" => "col-sm-10"), "label" => false, "class" => "form-control", "empty" => "- Pilih Parent -"));
            ?>
        </div>
