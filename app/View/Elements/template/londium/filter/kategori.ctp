<form action="#" role="form" class="form-horizontal panel-filter">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <span class="pull-left btn btn-xs btn-default toggle-bar" style="margin-left:5px" data-toggle-target="export"><i class="icon-bubble-forward"></i><?= __("Export") ?></span>
            <h6 class="panel-title">&nbsp;</h6>
            <a href="<?= Router::url("/kategori-add", true) ?>" class="pull-right btn btn-xs btn-default"><i class="icon-plus-circle2"></i><?= __("Tambah") ?></a>
        </div>
        <div class="panel-body toggle-target" style="display:none" data-toggle-id="filter">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Nama Kategori") ?></label>
                        <div class="col-md-8">
                            <input type="text" name="Kategori.nama" placeholder="<?= __("") ?>" class="form-control input-sm">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><?= __("Jenis Kategori") ?></label>
                        <div class="col-md-8">
                            <select name="Kategori.jenis_kategori_id" class="form-control input-sm">
